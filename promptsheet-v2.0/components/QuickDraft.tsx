        ...
        <section className="px-5 py-4">
            ...
            >
                ...
                <input
                    ...
                    className="w-full border border-slate-200 rounded-md px-3 py-2 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-300 mb-2"
                />
                ...
                <input
                    ...
                    className="w-full border border-slate-200 rounded-md px-3 py-2 text-sm text-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-300 mb-2"
                />

                {/* Textarea with RefreshCw clear icon */}
                <div className="relative">
                    <textarea
                        ...
                        rows={5}
                        className="w-full resize-none border border-slate-200 rounded-md p-3 pr-8 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-300 placeholder:text-slate-300"
                    />
                    <button
                        onClick={handleClear}
                ...
                <div className="mt-3 flex items-center justify-between">
                    <div className="flex items-center gap-1">
                        <button
                            onClick={handleUndo}
                            disabled={!canUndo}
                            className="rounded-md border border-slate-200 text-slate-500 p-1 hover:bg-slate-100 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                            title="Undo"
                        >
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="flex items-center gap-1.5 rounded-md border border-slate-200 text-slate-600 text-xs px-3 py-1.5 hover:bg-slate-100 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                        >
                        ...
                        <button
                            ...
                            disabled={!canSave}
                            className="flex items-center gap-1.5 bg-slate-800 text-white text-xs px-3 py-1.5 rounded-md hover:bg-slate-700 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                        >
